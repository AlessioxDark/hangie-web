    ...
    <div className="h-screen w-full flex flex-col justify-between ">
      <div className="">
        <div className="w-full flex items-center flex-row  sticky bg-bg-1 z-30 top-0">
          <header className="flex w-full flex-row gap-4 items-center px-4 py-3 border-b border-text-2">
            <div className="bg-primary rounded-xl py-1 px-2.5">
              <span className="font-body text-bg-1 font-black text-3xl">H</span>
            </div>
