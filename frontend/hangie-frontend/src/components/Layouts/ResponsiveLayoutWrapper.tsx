...
const ResponsiveLayoutWrapper = ({ children, layoutType = "standard" }) => {
  ...
  if (currentScreen !== "xs") {
    ...
    //   <div className="border-2 border-text-3 rounded-xl">
    ...
    return (
      <>
        ...
        <div className="hidden lg:flex flex-col items-center justify-center min-h-screen bg-bg-1 text-white p-6 text-center select-none">
        ...
        {/* Contenitore App Mobile (nascosto su schermi grandi) */}
        <div className="lg:hidden block">
          {/* Inserisci qui il resto dei tuoi componenti (Navbar, Feed, ecc.) */}
        </div>
      </>
    );
